...
export const getAllUsers = [
  asyncHandler(async (req, res) => {
    const users = await User.findAll({
      attributes: ['Id', 'Name', 'Surname', 'Username', 'Email', 'CreatedAt'],
    ...
    return res.status(200).json({ success: true, data: payload, count: payload.length });
  }),
];
...
export const deleteUser = [
  ...
  asyncHandler(async (req, res) => {
    ...
    // Solo el usuario a sí mismo o un admin puede eliminar
