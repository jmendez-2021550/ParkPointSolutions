...
export const config = {
  ...
  // Dynamic pricing thresholds and multipliers
  pricing: {
    defaultBasePriceCents: parseInt(process.env.DEFAULT_BASE_PRICE_CENTS || '0', 10),
    ...
    highMultiplier: parseFloat(process.env.PRICING_HIGH_MULT || '1.5'),
    lowMultiplier: parseFloat(process.env.PRICING_LOW_MULT || '0.8'),
  },
