...
export const User = sequelize.define(
  'User',
  {
    Id: { type: DataTypes.STRING(16), primaryKey: true, field: 'id', defaultValue: () => generateUserId() },
    Name: { type: DataTypes.STRING(25), allowNull: false, field: 'name' },
    Surname: { type: DataTypes.STRING(25), allowNull: false, field: 'surname' },
    ...
    Status: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false, field: 'status' },
