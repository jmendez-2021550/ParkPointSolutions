...
export const serializeParkingSpots = (spots) => {
  return spots.map(serializeParkingSpot);
};
...
export const serializeReservations = (reservations) => {
